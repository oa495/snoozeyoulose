...
var GetReportCountTest = function(session) {
    /*
        Create a new instance of the GetReportCountTest Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Amazon/Marketplace/Reports/GetReportCountTest"
    GetReportCountTest.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetReportCountTestResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetReportCountTestInputSet();
    }
...
var GetReportCountTestInputSet = function() {
    GetReportCountTestInputSet.super_.call(this);
        /*
        Set the value of the AWSAccessKeyId input for this Choreo. ((required, string) The Access Key ID provided by Amazon Web Services.)
        */
        this.set_AWSAccessKeyId = function(value) {
        ...
        */
        this.set_MWSAuthToken = function(value) {
...
var GetReportCountTestResultSet = function(resultStream) {
    GetReportCountTestResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (Stores the response from Amazon.)
        */
        this.get_Response = function() {
...
util.inherits(GetReportCountTest, choreography.Choreography);
util.inherits(GetReportCountTestInputSet, choreography.InputSet);
util.inherits(GetReportCountTestResultSet, choreography.ResultSet);
exports.GetReportCountTest = GetReportCountTest;
